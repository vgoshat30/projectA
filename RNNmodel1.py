"""Creating RNN Classes
    ...
    -------
    SignQuantizerNetRNN
        A class containing the feed forward function: forward(self, x) with RNN layer and sign quantization
    SignQuantizerNetLSTM
        A class containing the feed forward function: forward(self, x) with LSTM layer and sign quantization
"""
